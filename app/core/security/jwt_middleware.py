...
async def get_current_user(
    ...
    if credentials is None:
        raise HTTPException(status_code=401, detail="No estás autenticado. Proporciona un token válido.")
    ...
    if user_repository.is_token_blacklisted(token):
        raise HTTPException(status_code=401, detail="Token inválido o ya ha sido cerrada la sesión.")
